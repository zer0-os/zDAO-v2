...
// In place of IVotesUpgradeable as it was merged IERC5805 with VotesUpgradeable in OZ v5
    ...
    GovernorPreventLateQuorumUpgradeable
{
    ...
    function setUp(bytes memory initializeParams) public initializer {
        (
            ...
            uint48 _initialVoteExtension
                ...
                initializeParams,
                (address, address, address, address, string, uint48, uint32, uint256, uint256, uint48)
            );
        owner = _owner;
        target = _target;
    ...
    ) internal { // TODO removed override after adjusting, track this down
    ...
    function _castVote(
        ...
        return GovernorUpgradeable._castVote(proposalId, account, support, reason, params);
    }
    ...
    // Override
    function _tallyUpdated(uint256 proposalId) internal virtual override(GovernorUpgradeable, GovernorPreventLateQuorumUpgradeable) {
        GovernorUpgradeable._tallyUpdated(proposalId);
    }
}